...
6. **M6: Address book + Mapbox.** ⏳ NEXT — see `docs/M6_BRIEF.md`. PWA shell scaffold (replacing placeholder `web/index.html`); Mapbox Search JS Core autocomplete + on-demand pin confirmation; address add/edit/archive UI. Surfaces existing 14 legacy addresses + future user-added.
